...
config :hello, Hello.Repo,
  username: "jshbdfdhbfgjhdfg",
  password: "skjfg kdjf gkdfg",
  hostname: "localhost",
  database: "kdjfgnskjf gjkd fgjd fk",
  stacktrace: true,
...
config :hello, HelloWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "IQ+jHZcHaBqdN6G/hrB7s1mCG2kcGSwEoOAxSPgp/t3yW5QgV31m6MqBt+cFvftt",
  watchers: [
